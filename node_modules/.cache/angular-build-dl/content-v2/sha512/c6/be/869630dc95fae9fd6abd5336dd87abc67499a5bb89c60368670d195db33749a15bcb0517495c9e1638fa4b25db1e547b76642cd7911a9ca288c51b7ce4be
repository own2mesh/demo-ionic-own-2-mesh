(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var Own2MeshOkLokPlugin = _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"].Own2MeshOkLokPlugin;
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage() {
          ...
          this.lockOKGSS101 = {
            name: 'OKGSS101',
            address: 'OKGSS101',
            secret: ['0x4c', '0x5f', '0xc', '0x3c', '0x4c', '0x28', '0x53', '0x24', '0x20', '0x36', '0x14', '0x5b', '0x53', '0x59', '0x20', '0x4'],
         ...
         * Test Methode
         *
         * Call this methode to make sure you can comunicate with the plugin.
        ...
        _createClass(HomePage, [{
          ...
          value: function echo() {
            ...
            Own2MeshOkLokPlugin.echo({
              ...
              _this2.echoStatus = result.value;
            });
          }
          /**
           * Open lock
          ...
          key: "openLock",
          value: function openLock() {
            var _this3 = this;

            // const {Own2MeshOkLokPlugin} = Plugins;
            console.log('LockId: ', this.lockOKGSS101);
            Own2MeshOkLokPlugin.open({
              ...
              console.log('Result = ', result);
              _this3.openLockStatus = result.opened;
            });
          }
          /**
          ...
          value: function batteryInfo() {
            ...
            Own2MeshOkLokPlugin.battery_status({
              ...
              _this4.batteryStatus = result.percentage;
              console.log('this.batteryStatus ', _this4.batteryStatus);
            });
          }
          /**
          ...
          value: function lockStatus() {
            ...
            Own2MeshOkLokPlugin.lock_status({
              ...
              console.log('Result = ', result);
              _this5.lockedStatus = result.locked;
            });
          }
        }]);
